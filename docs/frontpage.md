...
The trained model is remarkably accurate in predicting whether photos in the Boston image dataset are of buildings or of people. The prediction includes probabilities between 0 and 1 that the image belongs to either of the two classes.
